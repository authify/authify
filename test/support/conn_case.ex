defmodule AuthifyWeb.ConnCase do
  @moduledoc """
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = Authify.AccountsFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    {:ok, token, _claims} = Authify.Guardian.encode_and_sign(user)
