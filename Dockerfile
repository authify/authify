...
RUN apt-get update -y && \
  apt-get install -y libstdc++6 openssl libncurses6 lksctp-tools locales ca-certificates \
  && apt-get clean && rm -f /var/lib/apt/lists/*_*
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/authify ./
