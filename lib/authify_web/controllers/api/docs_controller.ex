defmodule AuthifyWeb.API.DocsController do
  ...
  defp build_paths do
    %{
      ...
      "/{org_slug}/api/saml-providers" => build_saml_providers_endpoints(),
      "/{org_slug}/api/saml-providers/{id}" => build_saml_provider_endpoints(),
  ...
  # SAML Provider endpoint builders
  defp build_saml_providers_endpoints do
    %{
      parameters: [
        %{"$ref" => "#/components/parameters/OrgSlug"},
        %{"$ref" => "#/components/parameters/AcceptHeader"}
  ...
  defp build_saml_provider_endpoints do
    %{
      parameters: [
        %{"$ref" => "#/components/parameters/OrgSlug"},
        %{"$ref" => "#/components/parameters/AcceptHeader"}
      ...
      put: %{
        ...
        description:
          "Update a SAML service provider's configuration. Requires `saml:write` scope.",
        security: [
          %{"OAuth2" => ["saml:write"]},
          %{"BearerAuth" => []},
          %{"SessionAuth" => []}
