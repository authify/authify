  ...
  defp configuration_endpoint do
    %{
      ...
      get: %{
        ...
        description:
          "Retrieve organization configuration settings. For authify-global organization, returns global settings (allow_organization_registration, site_name, support_email). For regular organizations, returns organization-specific settings (allow_invitations, allow_saml, allow_oauth, oauth_21_strict_mode, allow_webauthn, scim_inbound_provisioning_enabled, description, website_url, contact_email, logo_url).",
        security: [
          %{"OAuth2" => ["organizations:read"]},
          %{"BearerAuth" => []},
          %{"SessionAuth" => []}
      ...
      put: %{
        ...
        description:
          "Update organization configuration settings. Settings vary by organization: Global settings for authify-global (allow_organization_registration, site_name, support_email), Organization settings for regular orgs (allow_invitations, allow_saml, allow_oauth, oauth_21_strict_mode, allow_webauthn, scim_inbound_provisioning_enabled, description, website_url, contact_email, logo_url).",
        security: [
