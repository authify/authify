defmodule Authify.Repo.Migrations.AddExternalIdToUsers do
  use Ecto.Migration
  ...
  def change do
    ...
    create unique_index(:users, [:external_id, :organization_id],
             name: :users_external_id_organization_id_index
           )

    # Optimize SCIM filter queries
    create index(:users, [:organization_id, :external_id])
  end
end
